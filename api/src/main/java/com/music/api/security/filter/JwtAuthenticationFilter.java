package com.music.api.security.filter;

import com.music.api.security.component.JwtComponent;
import com.music.api.security.user.AuthenticationUserException;
...
import static com.music.api.security.component.JwtType.ACCESS;
import static com.music.api.security.component.JwtType.REFRESH;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        } catch (AuthenticationUserException ex) {
            ex.printStackTrace();
